...
export const HouseDrafts = () => {

    const [items, setItems] = useState()

    useEffect(() => {
        try {
            axios.get('https://archneo.herokuapp.com/v1/house-drafts').then((res) => {
        ...
        <div>
            ...
            <section className="bg-white border-b py-2">
                <div className="container max-w-5xl mx-auto m-2">
                    <h2 className="w-full my-2 text-3xl font-bold leading-tight text-center text-gray-800">House Drafts</h2>
            ...
            <svg className="width: 100%; height: auto;" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 xmlnsXlink="http://www.w3.org/1999/xlink">
