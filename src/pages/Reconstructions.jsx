...
export const Reconstructions = () => {
    ...
    useEffect(() => {
        try {
            axios.get('https://archneo.herokuapp.com/v1/reconstructions').then((res) => {
        ...
        <div>
            ...
            <section className="bg-white border-b py-2">
                <div className="container max-w-5xl mx-auto m-2">
                    <h2 className="w-full my-2 text-3xl font-bold leading-tight text-center text-gray-800">Reconstructions</h2>
